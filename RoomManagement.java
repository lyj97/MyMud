...
public class RoomManagement {
	...
	public static void creatRooms() {
        ...
        room_mingyufang.SetRoomName("鸣玉坊");
        room_mingyufang.setDescription("这日正是暮春天气，华灯初上，鸣玉坊各家院子中传出一片丝竹和欢笑之声，中间又夹着猜枚行令，唱曲闹酒，当真是笙歌处处，一片升平景象。");

        Room room_shouxihu = new Room();
        room_shouxihu.setRoomId("yangzhou_shouxihu");
        room_shouxihu.SetRoomName("瘦西湖");
        room_shouxihu.setDescription("");

        Room room_damingsi = new Room();
        room_damingsi.setRoomId("yangzhou_damingsi");
        room_damingsi.SetRoomName("扬州大明寺");
        room_damingsi.setDescription("");

        Room room_dajiulou = new Room();
        room_dajiulou.setRoomId("yangzhou_dajiulou");
        room_dajiulou.SetRoomName("大酒楼");
        room_dajiulou.setDescription("");

        Room room_zhubaodian = new Room();
        room_zhubaodian.setRoomId("yangzhou_zhubaodian");
        room_zhubaodian.SetRoomName("珠宝店");
        room_zhubaodian.setDescription("");
        ...
        room_yueqidian.SetRoomName("乐器店");
        room_yueqidian.setDescription("这是一家古色古香的店铺，店内看起来很是整洁讲究，想必所售物品价值不菲。");

        Room room_bailushuyuan = new Room();
        room_bailushuyuan.setRoomId("yangzhou_bailushuyuan");
        room_bailushuyuan.SetRoomName("白鹿书院");
        room_bailushuyuan.setDescription("");

        Room room_zahuopu = new Room();
        room_zahuopu.setRoomId("yangzhou_zahuopu");
        room_zahuopu.SetRoomName("杂货铺");
        room_zahuopu.setDescription("");

        Room room_yaopu = new Room();
        room_yaopu.setRoomId("yangzhou_yaopu");
        room_yaopu.SetRoomName("药铺");
        room_yaopu.setDescription("");

        Room room_jimaidian = new Room();
        room_jimaidian.setRoomId("yangzhou_jimaidian");
        room_jimaidian.SetRoomName("寄卖店");
        room_jimaidian.setDescription("");
        ...
        room_guangchang.setRoom(CommonContent.DIRECTION.NORTHWEST, room_mingyufang);
        room_guangchang.setRoom(CommonContent.DIRECTION.SOUTHEAST, room_yueqidian);
        ...
        room_xidajie3.setRoom(CommonContent.DIRECTION.NORTH, room_dajiulou);
        ...
        room_mingyufang.setRoom(CommonContent.DIRECTION.SOUTHEAST, room_guangchang);
        ...
        room_dajiulou.setRoom(CommonContent.DIRECTION.SOUTH, room_xidajie3);
        ...
        room_dongdajie1.setRoom(CommonContent.DIRECTION.NORTH, room_yueqidian);
        ...
        room_dongdajie2.setRoom(CommonContent.DIRECTION.NORTH, room_bailushuyuan);
        ...
        room_yueqidian.setRoom(CommonContent.DIRECTION.NORTHWEST, room_guangchang);
        room_bailushuyuan.setRoom(CommonContent.DIRECTION.SOUTH, room_dongdajie2);
        room_zahuopu.setRoom(CommonContent.DIRECTION.NORTH, room_dongdajie2);
        room_yaopu.setRoom(CommonContent.DIRECTION.NORTH, room_dongdajie3);
        room_jimaidian.setRoom(CommonContent.DIRECTION.SOUTH, room_dongdajie3);
        ...
        cityMap.put(room_dajiulou.getRoomId(), room_dajiulou);
        ...
        cityMap.put(room_bailushuyuan.getRoomId(), room_bailushuyuan);
